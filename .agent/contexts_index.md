...
| [ontology_rationale.md](contexts/ontology_rationale.md)         | Scope reckoning (Path A vs B decision), OEO fitness assessment, `ontocal:` class hierarchy, predicate table, provenance module spec, SOSA/M3 design, extensions architecture, namespace policy, SPARQL examples. The definitive ontology reference. | Current and authoritative                      |
